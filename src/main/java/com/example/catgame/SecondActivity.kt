...
class SecondActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        petImageView.setImageResource(R.drawable.frontpage)

        feedButton.setOnClickListener {
            if (!isPetDead) {

                petImageView.setImageResource(R.drawable.catfeeding)
    ...
    private fun petDies() {
        ...
        findViewById<ImageView>(R.id.deathImageView).apply {
            ...
            setImageResource(R.drawable.catdeath)
        }
        isPetDead = true
